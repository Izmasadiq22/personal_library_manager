...
def add_book(library):
    ...
    read = input("Have you ever read this book? (yes/no): ").strip().lower() == "yes"
...
def remove_book(library):
    title = input("Enter the title of the book you want to remove from the library: ").strip().lower()
...
def display_statistics(library):
    ...
    print(f"Percentage of books read: {percentage_read_books:.2f}%")
